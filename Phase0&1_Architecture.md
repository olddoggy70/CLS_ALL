...
├── docs/
│   ├── Phase0&1_Architecture.md    # Architecture documentation
│   ├── Operations_Manual.md        # Operations/runbook guide
│   └── comprehensive_project_review.md  # Code quality review
├── logs/
│   └── pipeline_YYYYMMDD.log       # Daily log files (auto-generated)
└── data/
    ├── database/
    ...
    ├── ref_files/                 # Reference mapping files
    │   ├── MFN Mapping.xlsx       # Manufacturer number mapping
    │   ├── VN Mapping.xlsx        # Vendor number mapping
    │   └── Blank Vpn Permitted.xlsx  # Permitted blank vendor catalogue
    └── output/
